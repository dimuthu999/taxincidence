...
# Data
From zillow.com. 3,030 rental listings in California from 192 zipcodes which had a population of more than 50000 in 2010
...
stargazer(ols,omit = c("zip"),omit.labels = c("zip"),type="text",no.space = TRUE,omit.stat = c("f","rsq","ser"),notes= "Robust Standard Errors",column.labels = c("All Years","All Years","Increasing Years","Decreasing Years","All Years"),add.lines = list(c("Mfx % of mean per 1 sd",round(mfx*100,2)))) #,report=('vc*p'),se=se
...
stargazer(ols,omit = c("zip","prop_tax_2007_cat"),omit.labels = c("zip","prop tax 2007 cat"),type="text",no.space = TRUE,omit.stat = c("f","ser"),notes= "Robust Standard Errors",column.labels = c("All Years"))
```
